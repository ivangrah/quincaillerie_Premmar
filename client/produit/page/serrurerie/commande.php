...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-links">
            ...
            <li><a href="../serrurerie/index.php"><i class="fa-solid fa-plug"></i> serrurerie</a></li>
    ...
    <div class="nav-mobile" id="navMobile">
        ...
        <a href="../electricite.php"><i class="fa-solid fa-plug"></i> serrurerie</a>
        ...
        <div class="split-wrapper">
            ...
            <div class="panel-left">
                ...
                <div class="prod-image-wrap">
                    <img src="../../images/serrurerie/<?= htmlspecialchars($produit['image']) ?>"
